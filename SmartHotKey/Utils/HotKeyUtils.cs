...
namespace SmartHotKey.Utils
{
    ...
    internal sealed class HotKeyUtils
    {
        ...
        public static bool RegisterKey(Control winHandle, int hotKeyId, string strKey)
        {
            if (strKey == null)
            {
                strKey = "";
        ...
        /// <param name="key">HotKey</param>
        /// <returns>success flag of register action</returns>
        public static bool RegisterKey(Control winHandle, int id, Keys key)
        {
            ...
            keyModifierNone |= CheckModifier(key, Keys.Alt, HotKeyModifiers.Menu);
        ...
        public static bool UnregisterKey(Control winHandle, int hotKeyId)
        {
