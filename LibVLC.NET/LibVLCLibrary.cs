...
namespace LibVLC.NET
{
    ...
    : IDisposable
  {
   ...
   if((major != 1) && (minor != 2))
            ...
            m_libvlc_media_player_set_hwnd = (libvlc_media_player_set_hwnd_signature)LoadDelegate<libvlc_media_player_set_hwnd_signature>("libvlc_media_player_set_hwnd");
