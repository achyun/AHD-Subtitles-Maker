    ...
    */
    ...
    public int libvlc_media_player_pause(IntPtr p_mi)
    {
      ...
      return m_libvlc_media_player_pause(p_mi);
        ...
        //==========================================================================
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int libvlc_media_player_set_hwnd_signature(IntPtr p_mi, IntPtr handle);

        //==========================================================================
        private readonly libvlc_media_player_set_hwnd_signature m_libvlc_media_player_set_hwnd;

        //==========================================================================
        public int libvlc_media_player_set_hwnd(IntPtr p_mi, IntPtr handle)
        {
            VerifyAccess();

            return m_libvlc_media_player_set_hwnd(p_mi, handle);
        }
