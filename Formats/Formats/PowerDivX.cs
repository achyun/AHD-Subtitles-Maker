...
{
    public class PowerDivX : SubtitlesFormat
    {
        public override string Name
        {
            get { return "Power DivX (*.psb)"; }
        }

        public override string Description
        {
            get { return "Power DivX\n\nThis format type has this view:\n{00:00:00(SubStartTime:hou:min:sec)}{SubEndTime00:00:00}\n{00:01:00}{00:01:05}Text2\n........"; }
        }

        public override string[] Extensions
        {
            get { string[] _Extensions = { ".psb" }; return _Extensions; }
        }
        ...
        public override void Load(string filePath, Encoding encoding)
        {
            ...
            for (int i = 0; i < Lines.Length; i++)
            {
                try
                {
                    ...
                    Sub.EndTime = TimeFormatConvertor.From_TimeSpan(TextLines[3]);
        ...
        public override void Save(string filePath, Encoding encoding)
        {
            ...
            {
                string CurrentLine = "{" + TimeFormatConvertor.To_TimeSpan(this.SubtitleTrack.Subtitles[i].StartTime).Substring(1, 7) + "}{" +
                  TimeFormatConvertor.To_TimeSpan(this.SubtitleTrack.Subtitles[i].EndTime).Substring(1, 7) + "}" +
